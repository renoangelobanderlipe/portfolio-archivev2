...
export const AboutPage = () => {
  return (
    <ContainerWrapper style={'bg-background py-[100px]'}>
      <div className='flex flex-col-reverse phone-lg:flex-row gap-[80px]'>
